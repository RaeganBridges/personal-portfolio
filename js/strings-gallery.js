(function () {
  const root = document.getElementById("strings-gallery");
  if (!root || !Array.isArray(window.StringsGallery)) return;

  const frag = document.createDocumentFragment();
  window.StringsGallery.forEach(function (item) {
    ...
    img.src = item.file;
    img.alt = item.alt || "Strings project image";
